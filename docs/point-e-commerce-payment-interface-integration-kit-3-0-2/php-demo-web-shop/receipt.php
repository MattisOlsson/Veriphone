<?php
/**
 * Demo receipt page implementation
 */
...
verifysignature(formatparamters($signedformdata), $_POST["s-t-256-256_signature-one"]) ? $result = "valid"
        : $result = 'invalid';
